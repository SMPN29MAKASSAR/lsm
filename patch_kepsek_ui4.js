...
const startRegex = /<div className="relative w-full md:w-64 no-print">[\s\S]*?<\/div>\s*<\/div>\s*<div className="overflow-x-auto p-1">/;
...
const patched = code.replace(startRegex, newUI);
if (patched === code) {

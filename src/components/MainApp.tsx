          ...
          if (isCurfew && currentUser && currentUser.role !== 'admin' && currentUser.role !== 'kepsek') {
            return (
              <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4 fade-in">
                ...
                <p className="text-slate-600 text-lg max-w-md mx-auto mb-8 font-medium">Waktu istirahat belajar telah tiba. Akses Portal SKPD untuk Guru dan Siswa ditutup sementara mulai pukul 19:00 hingga 07:30 WITA demi menjaga keseimbangan waktu istirahat.</p>
